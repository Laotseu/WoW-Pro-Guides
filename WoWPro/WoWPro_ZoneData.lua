...
DefineInstance(1024, 0,"PathofHuln", "Path of Huln")
...
DefineInstance(1080, 0,"ThunderTotem","Thunder Totem")
...
DefineTerrain(2,11,  32, 0,"Deadwind Pass","Deadwind Pass")
DefineTerrainFloor(2,11, 32,21,"Dalaran@DeadwindPass","Deadwind Pass")
DefineTerrainFloor(6,11, 873,5,"The Ancient Passage","The Hidden Pass")
DefineTerrainFloor(7, 2, 970,1,"Umbral Halls", "Tanaan Jungle Intro")
DefineTerrainFloor(7, 3, 947,15,"Bloodthorn Cave", "Shadowmoon Valley@Draenor")
DefineTerrainFloor(8, 2, 1015,17,"NarthalasAcademy", "Narthalas Academy")
DefineTerrainFloor(8, 2, 1015,18,"OceanusCove", "Oceanus Cove")
DefineTerrainFloor(8, 6, 1017,9,"StormDrakeDen", "Storm DrakeDen")
DefineTerrainFloor(8, 6, 1017,25,"ThorignirRefuge", "Thorignir Refuge")
DefineTerrainFloor(8, 6, 1017,27,"AggramarsVault", "Aggramars Vault")
...
DefineDungeonArea( 1077,0,"TheDreamgrove","TheDreamgrove","The Dreamgrove")
...
DefineInstance( 1028,0,"Mardum, the Shattered Abyss","MardumtheShatteredAbyss")
DefineInstance( 1032,3,"Vault of the Wardens","VaultOfTheWardensDH")
-- DefineTerrainFloor( -1, 0, 1032, 1, "Vault of the Wardens", "VaultOfTheWardensDH" )