...
C Rescuing the Rescuers |QID|11244|NC|N|Click on Ceremonial Dragonflayer Harpoons.|M|57.29,56.53|S|
A Fresh Legs |QID|11251|N|From Scout Valory. This is an optional lead to a dungeon quest.\n\nClick it off if you don't want to do it.|M|56.0,55.8|O|
C Rescuing the Rescuers |QID|11244|NC|N|Finish clicking on Ceremonial Dragonflayer Harpoons.|M|57.29,56.53|US|
...
C Daggercap Divin' |QID|11443|NC|N|Collecting Valgarde Supply Crates until you finish this quest. |M|62.16,59.09|S|
C Into the World of Spirits |QID|11333|NC|U|34082|N|Equip the Diving Helm and look for a Reagent Pouch on the deck of a wrecked ship and loot it.|M|62.06,57.64|
C Daggercap Divin' |QID|11443|NC|N|Finish collecting Valgarde Supply Crates until you finish this quest. |M|62.16,59.09|US|
...
C Dragonflayer Battle Plans |QID|11290|NC|N|Loot the Dragonflayer Battle Plans at the end of the cave. |M|55.68,52.57|
...
C The Depths of Depravity |QID|11277|NC|N|Pick up Wyrmskull Tablets.|M|57.35,56.38|S|
C The Path to Payback |QID|11420|NC|N|Loot the Harpoon Operation Manual further inside.|M|59.26,55.38|
...
C The Shining Light |QID|11288|NC|N|Go down 2 flights of stairs to the west and head north at the bottom. Loot the Sacred Artifact at the end. Don't worry about the Ghouls, your shield will protect you. |M|56.64,53.43|
...
C The Depths of Depravity |QID|11277|NC|N|Finish picking up Wyrmskull Tablets. |M|57.35,56.38|US|
T The Depths of Depravity |QID|11277|M|56.9,53.8|N|To Glorenfeld.|
A The Ring of Judgment |QID|11299|M|56.9,53.8|N|From Glorenfeld.|
...
C The Echo of Ymiron |QID|11343|NC|U|33637|N|Use the Incense Burner inside this house and two Vrykuls will show up to have a conversation. Wait for the quest complete message, then cancel the buff. |M|60.15,50.84|
N Cancel Echo of Ymiron |QID|11343|N|Right click the Echo of Ymiron buff.|NOBUFF|42786|
...
K Harpoon Master Yavus |QID|11430|T|Harpoon Master Yavus|N|Go here and kill Harpoon Master Yavus. |M|65.15,56.58|
C Anguish of Nifflevar |QID|11344|NC|U|33774|N|Get out of the hut and use the Incense Burner, then go east towards a big crowd of Vrykul and wait for the quest complete message. |M|69.10,54.90|
...
C Trust is Earned |QID|11460|CHAT|N|Feed the grub to a Rock Falcon in the cage. |M|75.25,64.93|
...
C Tools to Get the Job Done |QID|11475|NC|N|Look for Building Tools down in the pit and loot them. |M|79.00,47.54|
...
C Industrial Strength Rope |QID|11483|NC|QO|Industrial Strength Rope: 1/1|N|Loot the Industrial Strength Rope here. |M|64.75,40.96|
C Large Barrel |QID|11483|NC|QO|Large Barrel: 1/1|N|Loot the Large Barrel here. |M|67.58,52.25|
...
C Steel Ribbing |US|QID|11484|QO|2|N|Kill Dragonflayer Warriors and Rune-Seers until you find a Steel Ribbing.|M|68.63,54.41|
C Pristine Shoveltusk Hide|QID|11484|N|Kill Shoveltusks until this drops.|M|72.6,64|US|QO|1|
C Let's Go Surfing Now |QID|11436|NC|N|Click the Large Harpoon Lever here to Harpoon Surf back to Valgarde. |M|65.24,57.23|
...
C We Can Rebuild It |QID|11483|CHAT|N|Dismount, then talk to McGoyver and choose the Dark Iron Ingots option, then "Yarp" to be flown back to the Explorer's League Outpost with the Dark Iron Ingots you need. |M|60.77,61.57|
...
C Iron Rune Constructs and You: Rocket Jumping |QID|11485|NC|N|Click the Work Bench next to Walt and click the chat bubble, then stand on the Teleport Rune and use the Rock Jump ability. |M|75.17,65.44|
...
C Iron Rune Constructs and You: Collecting Data |QID|11489|NC|N|Go to the Work Bench again, then go to the blue crystal near Gwendolyn and use the Collect Data ability. |M|74.82,65.73|
...
C Iron Rune Constructs and You: The Bluff |QID|11491|NC|N|Click the Work Bench again, then step on Lebronski's Rug. When he starts talking to you, use the Bluff ability. |M|74.80,65.28|
...
K Skeld Drakeson |QID|11182|T|Skeld Drakeson|QO|Skeld Drakeson slain: 1/1|N|Killing Proto-Whelp and Proto-Drake Eggs on your way, find Skeld Drakeson in this building and kill him. |M|41.48,52.34|
...
C Southwest Plague Tank |QID|11202|NC|QO|1|U|33164|N|Use the Ever-burning Torches on the Plague Tank here. |M|48.39,55.92|
C Northwest Plague Tank |QID|11202|NC|QO|2|U|33164|N|Use the Ever-burning Torches on the Plague Tank here. |M|48.06,52.86|
C Northeast Plague Tank |QID|11202|NC|QO|3|U|33164|N|Use the Ever-burning Torches on the Plague Tank here. |M|51.20,50.19|
C Southeast Plague Tank |QID|11202|NC|QO|4|U|33164|N|Use the Ever-burning Torches on the Plague Tank here. |M|51.54,57.74|
...
C Mission: Package Retrieval |QID|11327|NC|N|Loot the Apothecary's Package here. |M|50.76,53.89|
...
C Fengir's Clue |QID|11504|NC|QO|1|N|Loot Fengir's Clue here. |M|57.67,77.62|
C Rodin's Clue |QID|11504|NC|QO|2|N|Loot Rodin's Clue here. |M|59.27,77.00|
C Isuldof's Clue |QID|11504|NC|QO|3| |N|Loot Isuldof's Clue here. |M|59.79,79.39|
C Windan's Clue |QID|11504|NC|QO|4|N|Loot Windan's Clue here. |M|61.97,80.06|
...
f Kamagua |M|24.7,57.8|N|From Kip Trawlskip.|
...
K "Scoodles" |QID|11510|T|"Scoodles"|N|Find and kill "Scoodles" and loot his Sin'dorei Scrying Crystal. |M|36.40,85.27|
C Amani Vase |QID|11434|S|NC|QO|1|U|34076|N|Swim to the other ship here and loot the Amani Vase. |M|37.14,85.53|
C Eagle Figurine |QID|11434|NC|QO|2|U|34076|N|Use the Fish Bladder for underwater breathing, then dive down and loot the Eagle Figurine inside the ship here. |M|37.77,84.62|
C Amani Vase |QID|11434|US|NC|QO|1|U|34076|N|Swim to the other ship here and loot the Amani Vase. |M|37.14,85.53|
...
C Jack Likes His Drink |QID|11466|CHAT|N|Talk to Olga here and click the chat bubble to give her 1 gold. When Jack Adams passes out, click his chat bubble. |M|35.31,79.59|
...
C Sorlof's Booty |QID|11529|NC|N|Go to The Big Gun on the other side of the ship and click on the gun when the the ship engages Sorlof. Jump off when he dies and loot Sorlof's Booty. |M|39.18,67.77|
C The Staff of Storm's Fury |QID|11511|NC|N|Get on the ship here, but be careful of the elite. Downstairs, loot The Staff of Storm's Fury. |M|35.26,64.84|
...
C Scalawag Frog |QID|11476|NC|T|Scalawag Frog|QO|1|N|Click on a Scalawag Frog nearby. |M|35.90,80.62|
...
C Shield of the Aesirites |QID|11568|NC|QO|1|U|34624|N|Use the Bundle of Vrykul Artifacts here. |M|57.67,77.62|
C Staff of Storm's Fury |QID|11568|NC|QO|2|U|34624|N|Use the Bundle of Vrykul Artifacts here. |M|59.27,77.00|
C Frozen Heart of Isuldof |QID|11568|NC|QO|3|U|34624|N|Use the Bundle of Vrykul Artifacts here. |M|59.79,79.39|
C Ancient Armor of the Kvaldir |QID|11568|NC|QO|4|U|34624|N|Use the Bundle of Vrykul Artifacts here. |M|61.97,80.06|
...
C Absholutely... Thish Will Work! |QID|11330|NC|U|33627|N|In the keep's jail, use Peppy's Special Mix on the Dragonflayer Vrykul Prisoner. |M|29.45,43.40|
...
U Tough Ram Meat |QID|11284|U|33352|L|33477|N|Loot 4 Tough Ram Meat from Frosthorn Rams in the area. Combine the 4 Tough Ram Meat to get a Giant Yeti Meal.|M|71.57,13.76|
...
T March of the Giants |QID|11355|N|To Researcher Aderan.|M|62.6,16.5|

A The Lodestone |QID|11358|N|From Researcher Aderan.|M|62.6,16.5|
C The Lodestone |QID|11358|NC|U|33819|N|Use the Rune Sample at the Broken Tablet here and wait for the quest complete message. |M|71.63,17.61|
C Mastering the Runes |QID|11349|NC|N|Look for Iron Rune Carving Tools under the canopies in this area and loot them. |M|67.51,23.29|
...
C The Fallen Sisters |QID|11314|NC|U|33606|N|Use Lurielle's Pendant on Chill Nymphs until you complete the quest.|M|51.14,26.57|
...
T The Lodestone |QID|11358|N|To Researcher Aderan.|M|62.6,16.5|
A Demolishing Megalith |QID|11359|N|From Researcher Aderan.|M|62.6,16.5|
...
T Demolishing Megalith |QID|11359|N|To Researcher Aderan.|M|62.6,16.5|
...
C Gruesome, But Necessary |S|QID|11246|NC|U|33310|N|Dismember Vrykul corpses by using The Sergeant's Machete on them. |M|44.92,34.36|
...
A Stop the Ascension! |QID|11249|S|U|33314|N|Kill Vrykul mobs until you have the Vrykul Scroll of Ascension. Use the Vrykul Scroll of Ascension to get this quest.|M|45.3,27.0|
C Northwest Longhouse |QID|11247|NC|QO|Northwest Longhouse Set Ablaze: 1/1|U|33321|N|Go inside the longhouse here and use the Sergeant's Torch. |M|43.62,28.69|
C Northwest Tower |QID|11245|NC|QO|Northwest Tower Targeted: 1/1|U|33323|N|Get within 90 yards of the tower here and use the Sergeant's Flare. |M|43.61,29.91|
C Northeast Longhouse |QID|11247|NC|QO|Northeast Longhouse Set Ablaze: 1/1|U|33321|N|Go inside the longhouse here and use the Sergeant's Torch. |M|46.38,28.16|
C Barracks |QID|11247|NC|QO|3|U|33321|N|Go inside the Barracks here and use the Sergeant's Torch. |M|45.80,30.45|
C East Tower |QID|11245|QO|East Tower Targeted: 1/1|NC|U|33323|N|Get within 90 yards of the tower here and use the Sergeant's Flare. |M|46.70,32.85|
C Southeast Tower |QID|11245|QO|Southeast Tower Targeted: 1/1|NC|U|33323|N|Get within 90 yards of the tower here and use the Sergeant's Flare. |M|47.10,36.87|
...
A Stop the Ascension! |QID|11249|US|U|33314|N|Kill Vrykul mobs until you have the Vrykul Scroll of Ascension. Use the Vrykul Scroll of Ascension to get this quest.|M|45.3,27.0|
...
C Southwest Tower |QID|11245|NC|QO|3|U|33323|N|Get within 90 yards of the tower here and use the Sergeant's Flare. |M|43.18,36.11|
C Gruesome, But Necessary |US|QID|11246|NC|U|33310|N|Finish dismembering Vrykul corpses by using The Sergeant's Machete on them. |M|44.92,34.36|
...
A It's a Scourge Device |QID|11395|U|33961|M|22.6,28.6|N|Kill Scourge mobs until you get a Scourge Device and use it to start the quest.|
...
K Trident of the Son |QID|11422|T|Rotgill|N|Find Rotgill patrolling the coast here and kill him for Rotgill's Trident. |M|24.24,35.67|
...
A Gjalerbron Attack Plans |QID|11237|S|U|33289|M|35.1,16.0|N|Kill Vrykul here until you get Gjalerbron Attack Plans and use them to start the quest.|
C Of Keys and Cages |QID|11231|NC|N|Kill Vrykul mobs in this area and use their keys to open cages nearby. Free prisoners here until you complete the quest. |M|34.68,15.28|
...
A Gjalerbron Attack Plans |QID|11237|US|U|33289|M|35.1,16.0|N|Kill Vrykul here until you get Gjalerbron Attack Plans and use them to start the quest.|
...
K Squeeg Idolhunter |QID|11240|T|Squeeg Idolhunter|N|Drop off the cliff above the cave here and go inside to kill Squeeg Idolhunter.|M|30.69,34.48|
...
C Deathless Watchers|S|QID|11239|QO|Deathless Watcher slain: 10/10|N|Kill the Deathless Watchers you need for this quest.|M|33.91,9.91|
C Putrid Wights|S|QID|11239|QO|Putrid Wight slain: 2/2|N|Kill the Putrid Wights you need for this quest.|M|33.91,9.91|
;l Awakening Rods|QID|11432|L|34083 5|S|N|Kill Necrolords until you have 5 Awakening Rods.|M|33.91,9.91|
K Necro Overlord Mezhen |QID|11452|T|Necro Overlord Mezhen|L|34090|N|Kill Necro Overlord Mezhen here and loot Mezhen's Writings.|M|38.80,13.09|
A The Slumbering King |QID|11452|U|34090|M|38.8,13.0|N|From Mezhen's Writings.|
K Queen Angerboda |QID|11452|T|Queen Angerboda|N|Kill Queen Angerboda here. |M|40.89,6.47|
K Wyrmcaller Vile |QID|11238|T|Wyrmcaller Vile|QO|1;3|N|Kill Wyrmcaller Vile here last and loot the Wyrmcaller's Horn. Use it and kill Glacion when he arrives. |M|36.43,7.33|
K Glacion |QID|11238|T|Glacion|U|33282|N|Use the horn and kill Glacion when he arrives. |M|36.43,7.33|

C Deathless Watchers|US|QID|11239|QO|Deathless Watcher slain: 10/10|N|Kill the Deathless Watchers you need for this quest.|M|33.91,9.91|
C Putrid Wights|US|QID|11239|QO|Putrid Wight slain: 2/2|N|Kill the Putrid Wights you need for this quest.|M|33.91,9.91|
;l Awakening Rods|QID|11432|L|34083 5|US|N|Kill Necrolords until you have 5 Awakening Rods.|M|33.91,9.91|
C Sleeping Giants |S|QID|11432|NC|U|34083|N|Head into the cave area. Kill Necrolords to get Awakening Rods and use them on Dormant Vrykul until you finish this quest. If you need more Awakening Rods, kill Necrolords in the area. |M|35.81,12.69|
C Fearsome Horrors |QID|11239|QO|2|N|Kill Fearsome Horrors until you complete this quest. |M|35.33,12.21|
C Sleeping Giants |US|QID|11432|NC|U|34083|N|Head into the cave area. Kill Necrolords to get Awakening Rods and use them on Dormant Vrykul until you finish this quest. If you need more Awakening Rods, kill Necrolords in the area. |M|35.81,12.69|
