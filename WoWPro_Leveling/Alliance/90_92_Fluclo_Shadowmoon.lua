...
K Kuu'rat|QID|33833|T|Kuu'rat|N|Kill Kuu'rat, and loot the tusks. This is flagged as a 3-party group quest but can be solo'd by many. Don't forget to use your newly acquired Call to Arms to aid you in the battle.|M|34.6,26.9|
...
f Fey Landing |ALTFP|Elodor|N|With Vamuun.|M|58.7,31.9|
...
C Rangari Roundup |QID|34897|N|Finish finding the Hidden Rangari|US|CHAT|CS|M|47.1,53.1;46.4,51.6;45.0,50.4;44.8,51.2;43.9,52.7|
...
C The Fate of Karabor |QID|33059|N|Click on the Clarity Elixir to drink it|M|35.3,49.1|QO|1|NCU|111591|
