...
;N Breadcrumbs quests |QID|26735|N|Northern Stranglethorn is to the south of Duskwood. You can obtain one of two breadcrumbs into this zone, Rebels Without a Clue is offered by Sentinel Velene Starstrike at the Stardust Spire in Ashenvale, and from Sister Elsington in Raven Hill, Duskwood.  Alternatively, in-level players can obtain the Hero's Call from Stormwind City.\n\nThe next steps in this guide will be optional quests.\n\n|
A Rebels Without a Clue|QID|28699;26838|LEAD|26735|M|19.8,57.8|Z|Duskwood|N|From Sentinel Velene Starstrike at the Stardust Spire in Ashenvale, or from Sister Elsington in Raven Hill, Duskwood. The coordinates are for Sister Elsington in Duskwood.\n\nManualy check this step if you intend to take the Hero's Board version of this quest or if you prefer not to use breadcrumb quest at all.|O|
A Hero's Call: Northern Stranglethorn Vale!|QID|26838;28699|LEAD|26735|M|62.9,71.7|Z|Stormwind|N|From the Hero's Boards in Stormwind.\n\nManualy check this step if you do not intend to use any Breadcrumb quest for Northern Stranglethorn Vale.|O|
R Rebel Camp|QID|26735|M|47.9,11.8|N|Northern Stranglethorn is to the south of Duskwood.|

f Rebel Camp|QID|26735|M|47.9,11.8|N|At James Stillair.|

T Rebels Without a Clue|QID|26838|M|47.6,10.2|N|To Lieutenant Doren.|
T Hero's Call: Northern Stranglethorn Vale!|QID|28699|M|47.6,10.2|N|To Lieutenant Doren.|

A The Fate of Kurzen|QID|26735|M|47.6,10.2|N|From Lieutenant Doren.|
A Krazek's Cookery|QID|26740|M|47.1,10.7|N|From Corporal Kaleb.|
A Bad Medicine|QID|26732|M|47.3,11.1|N|From Brother Nimetz.|

R Nesingwary's Expedition|QID|26740|M|49.33,14.39;48.0,24.7;44.16,22.61|CS|N|Head to Nesingwary's Expedition.|
T Krazek's Cookery|QID|26740|M|43.6,23.1|N|To Krazek.|
A Venture Company Mining|QID|26763|M|43.6,23.1|N|From Krazek.|
A Supply and Demand|QID|26343|M|43.80,23.45|N|From Drizzlik.|
A Welcome to the Jungle|QID|583|M|44.2,22.1|N|From Barnil Stonepot.|
...
A Tiger Hunting|QID|185|M|44.5,22.7|N|From Ajeck Rouack.|
A The Green Hills of Stranglethorn|QID|26269|M|44.2,22.1|N|From Barnil Stonepot.|
A Panther Hunting|QID|190|M|43.7,22.3|N|From Sir S. J. Erlgadin.|
...
T The Green Hills of Stranglethorn|QID|26269|M|44.2,22.1|N|To Barnil Stonepot.|
...
T Venture Company Mining|QID|26763|M|43.6,23.1|N|To Krazek.|
A Return to Corporal Kaleb|QID|26765|M|43.6,23.1|N|From Krazek.|

R Rebel Camp|QID|26732|M|48.16,24.35;47.56,11.49|CC|N|Head back to the Rebel Camp.|
T Bad Medicine|QID|26732|M|47.3,11.1|N|To Brother Nimetz.|
A Control Sample|QID|26733|M|47.3,11.1|N|From Brother Nimetz.|
...
T Return to Corporal Kaleb|QID|26765|M|47.1,10.7|N|To Corporal Kaleb.|
T The Fate of Kurzen|QID|26735|M|47.6,10.2|N|To Lieutenant Doren.|
A Spared from Madness|QID|26736|M|47.6,10.2|N|From Lieutenant Doren.|
...
C Control Sample|QID|26733|S|M|63.22,22.16|N|Kill and loot Crystal Spine Basilisk. Make sure you loot before you raptor eats it all.|
C I Think She's Hungry|QID|26739|U|58165|M|63.22,22.16|N|Kill a Basilisk and let the your Raptor eat it.|
C Control Sample|QID|26733|US|M|63.22,22.16|N|Kill and loot Crystal Spine Basilisk. Make sure you loot before you raptor eats it all.|

T Control Sample|QID|26733|M|47.3,11.1|N|To Brother Nimetz.|
A The Source of the Madness|QID|26734|M|47.3,11.1|N|From Brother Nimetz.|
...
T Spared from Madness|QID|26736|M|47.6,10.2|N|To Lieutenant Doren.|
A Stopping Kurzen's Legacy|QID|26737|M|47.6,10.2|N|From Lieutenant Doren.|
...
K Chief Anders|QID|26737|T|Chief Anders|M|63.78,16.73|QO|Chief Anders slain: 1/1|N|Kill Chief Anders.|
K Chief Gaulus|QID|26737|T|Chief Gaulus|M|62.39,14.14|QO|Chief Gaulus slain: 1/1|N|Kill Chief Gaulus.|
K Chief Miranda|QID|26737|T|Chief Miranda|M|65.78,17.12|QO|Chief Miranda slain: 1/1|N|Kill Chief Miranda.|
K Chief Esquivel|QID|26737|T|Chief Esquivel|M|66.03,11.76|QO|Chief Esquivel slain: 1/1|N|Finally kill Chief Esquivel.|
C The Source of the Madness|QID|26734|M|62.73,17.60|N|Drops off of Kurzen's men in the cave.|US|

T The Source of the Madness|QID|26734|M|47.3,11.1|N|To Brother Nimetz.|
...
T Stopping Kurzen's Legacy|QID|26737|M|47.6,10.2|N|To Lieutenant Doren.|
...
T Tiger Mastery|QID|188|M|44.5,22.7|N|To Ajeck Rouack.|
...
T You Can Take the Murloc Out of the Ocean...|QID|26730|U|60273|N|To Emerine Junis. Use the sphere again to turn-in.|
...
T The Altar of Naias|QID|26731|U|60273|N|To Emerine Junis. Use the sphere again and complete the chain.|
...
T Panther Mastery|QID|193|M|43.7,22.3|N|To Sir S. J. Erlgadin.|
...
K A Physical Specimen|QID|26747|T|Gan'zulah|U|58165|M|24.92,18.27|N|Kill Gan'zulah and loot his body.|
...
K King Bangalash|QID|208|T|King Bangalash|M|47.79,58.84|N|Kill King Bangalash and loot his head. He is usually on top of the mound here.|
C Mind Vision|QID|26772|M|53.54,47.21|N|Kill Jungle Stalkers here and loot their feathers until the quest is complete.|
C The Mosh'Ogg Bounty|QID|26782|NC|M|67.16,54.03|N|Make your way here and loot the Bounty.|
K Mai'Zoth|QID|26781|T|Mai'Zoth|M|66.68,49.15;70.74,48.54|CS|N|Kill Mai'Zoth and loot the Mind's Eye. He is all the way in the back of the cave.|
...
C See Raptor|QID|26773|CHAT|M|53.4,66.7|N|Talk to Priestess Thaalia and tell her you are ready. The quest completes after the vision.|
...
C Nighttime in the Jungle|QID|26780|NC|M|58.10,73.17|S|N|Extinguish 8 Zul'Mamwe Braziers.|
K Braddok|QID|26774|T|Braddok|M|55.45,65.51;62.45,74.59|CS|N|Use the trail here to get up to the ruins. Kill Braddok and loot his brain.|
C Zul'Mamwe Mambo|QID|26779|M|59.77,72.01|US|N|Kill 16 Skullsplitter Trolls.|
C Nighttime in the Jungle|QID|26780|NC|M|58.10,73.17|US|N|Extinguish 8 Zul'Mamwe Braziers.|
...
C Speak with Tan'shang|QID|26775|CHAT|QO|Speak with Tan'shang: 1/1|M|89.07,46.32|N|Speak to the Priestess and begin the vision. Sneak around the trolls and talk to Tan'shang. Go slow!|
C Help Tenjiyu|QID|26775|CHAT|QO|Help Tenjiyu: 1/1|M|86.91,44.63|N|Talk to Tenjiyu. Then sneak into a tent and steal food from a sleeping troll, head back and talk to Tenjiyu again.|
C Speak with Chiyu|QID|26775|CHAT|QO|Speak with Chiyu: 1/1|M|82.8,37.53|N|Talk to Chiyu.|
C Escape from Zul'Gurub|QID|26775|QO|Escape from Zul'Gurub: 1/1|M|73.62,32.88|N|Finally, time to escape Zul'Gurub. To warn you, this is the hardest part.|
