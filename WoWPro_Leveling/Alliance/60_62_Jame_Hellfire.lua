...
h Honor Hold |QID|10160| |N|Set your hearthstone to Honor Hold. |M|54.20,63.60|
...
C Waste Not, Want Not|NC|S|N|Loot Metal Cogs and Wooden Planks off the ground until you finish this quest. |QID|10055|M|60.4,52.1|
C Fel Orc Scavengers |N|Kill Orcs until you finish this quest.|QID|10482|M|62.00,54.00|
C Waste Not, Want Not |NC|N|Loot Metal Cogs/Poles and Wooden Planks off the ground until you finish this quest. |QID|10055|M|60.4,52.1|US|
...
A Invading the Citadel|QID|29543|O|M|61.7,60.8|N|From Sergeant Altumus. This quest leads into Hellfire Ramparts, this is completely optional, there will be no follow up for it. Once you take it, feel free to join queue for Hellfire Ramparts if you wish.|
C The Path of Anguish |N|Kill the mobs needed for this quest.|QID|10142|M|65.00,58.00|
C Burn Eastern Thrower |QID|10078|NC|N|Burn the first thrower here with the Flaming Torch. |QO|Eastern Thrower Burned: 1/1|U|26002|M|58.50,46.80|
C Burn Central Eastern Thrower |QID|10078|NC|N|Burn the second thrower here with the Flaming Torch. |QO|Central Eastern Thrower Burned: 1/1|U|26002|M|55.85,46.75|
C Central Western Thrower |QID|10078|NC|N|Burn the third thrower here with the Flaming Torch. |QO|Central Western Thrower Burned: 1/1|U|26002|M|53.50,47.20|
C Western Thrower |N|Burn the last thrower here.|QID|10078|NC|QO|Western Thrower Burned: 1/1|U|26002|M|52.80,47.20|
...
C Ravager Egg Roundup|N|Get 12 Ravager eggs from the ground and the Ravagers.|QID|9349|NC|M|42.00,83.00|
...
C Zeppelin Debris|QID|10161|NC|N|Loot Zeppelin Debris from the ground.|S|
...
C Zeppelin Debris |QID|10161|NC|N|Gather the rest of the Zeplin debris you need.|M|62.42,70.70|US|
...
A Zeth'Gor Must Burn! |QID|10895|M|71.4,62.5|N|From Wing Commander Dabir'ee.|
C Cursed Talismans |N|Kill Orcs until you get the talismans for this quest.|QID|10484|M|64.2,71.8|S|
C Northern Tower |QID|10895|NC|N|Use the Smoke Beacon here.|QO|Northern Tower Marked: 1/1|U|31739|M|68.00,67.10|
C Forge Tower |QID|10895|NC|N|Use the Smoke Beacon here.|QO|Forge Tower Marked: 1/1|U|31739|M|70.20,69.20|
C Foothill Tower |QID|10895|NC|N|Use the Smoke Beacon here.|QO|Foothill Tower Marked: 1/1|U|31739|M|70.70,71.35|
C Southern Tower |N|Use the Smoke Beacon here.|QID|10895|NC|QO|Southern Tower Marked: 1/1|U|31739|M|66.45,76.35|
...
K Warlord of the Bleeding Hollow |N|Kill Warlord Morkh and take his armor.|QID|10485|T|Warlord Morkh|M|69.1,75.9;70.15,76.90|CS|
...
C Portal Kaalez |QID|10144|NC|N|Disrupt the portal here by clicking on it when inside.|QO|Disrupt Portal Kaalez: 1/1|M|72.70,58.95|
l Demonic Rune Stones |QID|10144||N|Kill Demons until you have 4 Demonic Rune Stones.|L|28513 4|M|71.50,55.15|
C Portal Grimh |N|Disrupt the portal here.|QID|10144|NC|QO|Disrupt Portal Grimh: 1/1|M|71.50,55.15|
...
C Mission: The Murketh and Shaadraz Gateways |N|Talk to Wing Commander Dabir'ee to begin flying and then use the hotkeyed bomb to destroy the gateways.|QID|10146|M|71.40,62.50|U|28038|
...
C Mission: The Abyssal Shelf |N|Talk to Gryphoneer Windbellow and begin flying, then bomb the mobs needed for this quest.  |QID|10163|U|28132|M|78.35,34.36|
...
C Disruption - Forge Camp: Mageddon|N|Kill the mobs needed for this quest here.|QID|10394|S|QO|Gan'arg Servant slain: 10/10|M|65.00,31.00|
K Razorsaw|N|Kill Razosaw.|QID|10394|T|Razorsaw|QO|Razorsaw slain: 1/1|M|65.00,31.00|
C Disruption - Forge Camp: Mageddon|N|Kill the mobs needed for this quest here.|QID|10394|US|QO|Gan'arg Servant slain: 10/10|M|65.00,31.00|
...
K Warbringer Arix'Amal |QID|10397|T|Warbringer Arix'Amal|QO|Warbringer Arix'Amal slain: 1/1;Burning Legion Gate Key: 1/1|N|The Warbringer is at the waypoint. Kill him and loot the key.|M|53.08,26.4|
...
C Draenei Prayer Beads|QID|10916|NC|M|54.9,63.6;54.16,63.32|CS|N|The payer beads are outside behind the Inn.|
r Sell junk, repair, restock |N|Sell junk, repair, restock  |M|54.65,63.53|QID|10916|
A Hellfire Fortifications |QID|13408;13410|O|M|56.34,62.78|N|From Warrant Officer Tracy Proudwell. This is optional as it is a PvP quest, so skip if you don't wish to do it.|
...
A Missing Missive |N|Kill worms until you get an Eroded Leather Case. Right-click the case to accept the quest. |QID|9373|S|U|23338|M|47.8,65.8|
...
A Missing Missive |N|Kill worms until you get an Eroded Leather Case. Use the case to accept the quest.|QID|9373|US|U|23338|M|47.8,65.8|
C Fel Spirits |N|Use the Anchorite Relic in your inventory when you are near some orcs.  Kill the orcs while near the relic, then kill the Fel Spirits that spawn until you finish this quest.|QID|10909|M|46.00,74.00|U|31772|
...
C The Exorcism of Colonel Jules|N|Talk to Anchorite Barada and start the ritual. Kill the mobs that spawn. When there are too many mobs in the room, use the Prayer Beads to kill them. Talk to Colonel Jules afterwards to finish it.|QID|10935|M|53.90,63.55|U|31828|
...
K The Mastermind |N|Kill Z'Kral, he is all the way in the back of Honor Hold Mine.|QID|10099|T|Z'Kral|M|56.00,61.00|
T The Mastermind |QID|10099|M|52.0,62.6|N|To Foreman Biggums.|
C The Path of Glory |S|U|25889|N|Click Skeletal Remains on the ground around here until you finish this quest.|QID|10047|M|63.00,49.00|
K Drill the Drillmaster |N|Kill Drillmaster Zurok. He is surrounded so carefully pick off the mobs around him, as he will call for help. He has double the health of the mobs around him, but doesn't hit hard.|QID|10937|T|Drillmaster Zurok|M|47.89,56.11|
C The Path of Glory |US|U|25889|N|Click Skeletal Remains on the ground around here until you finish this quest.|QID|10047|M|63.00,49.00|
...
A Avruu's Orb |N|Head to the waypoint above the small cave, then kill Avruu and take his Orb. Use the Orb to accept this quest.|QID|9418|T|Avruu|U|23580|M|25.7,75.1|
...
K The Rock Flayer Matriarch|N|Kill and loot Blacktalon in this cave.|QID|9490|T|Blacktalon the Savage|M|34.00,64.00|
C Deadly Predators |US|N|Kill the Stonescythe Alphas and Whelps needed for this quest.|QID|9398|M|32.00,61.00|
C Hellfire Fortifications |N|Do this quest by taking over the towers.|QID|13408;13410|M|40.76,49.64;39.81,56.49;35.38,56.42|CN|
...
K Arch Mage Xintor|N|Kill Arch Mage Xintor.|QID|10057|T|Arch Mage Xintor|M|53.60,81.00|QO|Arch Mage Xintor slain: 1/1|
K Lieutenant Commander Thalvos|QID|10057|T|Lieutenant Commander Thalvos|QO|Lieutenant Commander Thalvos slain: 1/1|M|54.7,83.6|N|Kill Lieutenant Commander Thalvos.|
C An Old Gift|N|Loot the book here.|QID|10058|NC|M|55.00,86.80|
...
T Hellfire Fortifications|QID|13408;13410|M|56.34,62.78|N|To Warrant Officer Tracy Proudwell.|O|
...
T An Ambitious Plan |QID|9383|M|23.2,36.7|N|To Elsaana.|
...
K Arazzius the Cruel |T|Arazzius the Cruel|N|Kill Arazzius the Cruel.|QID|10400|M|43.3,31|
...
C Manni's Cage |N|Free Manni from his cage.|QID|10238|NC|QO|Manni Saved: 1/1|M|45.10,41.10|
C Moh's Cage |N|Free Moh from his cage.|QID|10238|NC|QO|Moh Saved: 1/1|M|46.41,45.09|
C Jakk's Cage |N|Free Jakk from his cage.|QID|10238|NC|QO|Jakk Saved: 1/1|M|47.50,46.70|
...
K Urga'zz|N|Go in the cave and kill Urga'zz.|QID|10630|T|Urga'zz|M|53.90,31.70|
...
C Testing the Antidote |N|Find a Hulking Helboar and use the Antidote after getting it to low health.|QID|10255|M|18.0,53.2|
T Testing the Antidote |QID|10255|M|15.7,52.0|N|To Thiah Redmane.|
C Sha'naar Relics |N|Grab the 10 relics needed for this quest.|QID|9430|M|15.1,55.7|S|NC|
...
C A Traitor Among Us |N|Get the key from the chest here.|QID|10367|NC|M|14.35,63.35|
T A Traitor Among Us |QID|10367|M|16.3,65.1|N|To Naladu.|
A The Dreghood Elders |QID|10368|M|16.3,65.1|N|From Naladu.|
C Free Morod |N|Free Morod here.|QID|10368|CHAT|QO|Morod Freed: 1/1|M|13.10,61.00|
C Free Aylaan |N|Free Aylaan here.|QID|10368|CHAT|QO|Aylaan Freed: 1/1|M|13.00,58.40|
