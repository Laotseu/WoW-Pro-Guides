...
A Checking Up|QID|29566|M|78.40,62.10|N|From Ysiel Windsinger. This quest leads into The Slave Pens, this is completely optional, there will be no follow up for it. Once you take it, feel free to join queue for The Slave Pens if you wish.|O|
...
C Fulgor Spores|N|Loot the green mushroom looking things off the ground around Telredor, until you finish this quest.|M|67.00,50.0|QID|9777|NC|
l Fertile Spores|QID|9806|S|L|24449 6|N|From now on, kill then loot Sporebats, Greater Sporebats, Marsh Walkers and Fen Striders, and keep any Fertile Spores you find, you will need 6.|
...
C Withered Basidium|QID|9901|N|Kill and loot Withered Giants until you get the Withered Basidium.|S|
K Unfinished Business|T|Sporewing|N|Go here, find, then kill Sporewing. It wanders between the waypoints.|M|77.00,45.0;79.52,47.75|CN|QID|9901|
...
l Unidentified Plant Parts|QID|10355|S|N|Kill mobs until you have at least 30 Unidentified Plant Parts. Reason being that another quest opens when you are Friendly with the Cenarion Expedition.|L|24401 30|M|82.00,39.0|
...
C Disturbance at Umbrafen Lake|NC|N|Go to this spot to automatically finish this quest. Kill any Naga you come across as well.|M|69.40, 79.7|QID|9716|
...
K Boglash|N|Kill Boglash, he wanders so it may take a minute to find him.|M|82.00,74.0|QID|9895|T|Boglash|
...
C As the Crow Flies|N|Use the Stormcrow Amulet to take a ride around the zone.|QID|9718|NC|U|25465|
...
C A Damp, Dark Place|QID|9788|NC|N|After you enter the cave, go right at the first fork, then right again at the second fork and down the slope, Ikeyen's Belongings are down the bottom on top of a flat rock.|M|70.53,97.91|
K Lord Klaq|N|Kill Lord Klaq inside the cave.|M|72.00, 94.0|QID|9894|T|Lord Klaq|
...
C Umbrafen Lake Controls Disabled|QID|9720|NC|QO|Umbrafen Lake Controls Disabled: 1/1|N|Use the ironvine seeds on the control panel at|M|70.5,80.|U|24355|
...
C Lagoon Controls Disabled|N|Go here and disable the pump with the Ironvine Seeds.|M|63.10,64.1|QID|9720|NC|QO|Lagoon Controls Disabled: 1/1|U|24355|
K Rajah Haghazed|N|Kill Rajah Haghazed.|M|65.00,69.0|QID|9730|T|Rajah Haghazed|
...
K Blacksting|N|Kill Blacksting and take his Stinger.|M|50.00,59.0|QID|9896|T|Blacksting|
C The Boha'mu Ruins|N|Go here to complete the quest.|M|44.20,68.9|QID|9786|NC|
C Drain Schematics|N|Go here and dive underwater a bit until you get the quest complete message.|M|50.50,41.0|QID|9731|NC|
C Serpent Lake Controls Disabled|QID|9720|NC|QO|Serpent Lake Controls Disabled: 1/1|U|24355|N|Use the Ironvine Seeds here.|M|62.00,41.0|
K Rajis Fyashe|N|Kill Rajis Fyashe here.|M|65.00,41.0|QID|9817|T|Rajis Fyashe|
...
A What's Wrong at Cenarion Thicket?|QID|9957|M|78.5,63.1|N|From Lethyn Moonfire. This quest is optional since it is a lead in for Terrokar Forest.|O|
...
C Daggerfen Poison Vial|N|Go in this area and loot the Daggerfen Poison Vial.|M|25.40,25.0|QID|9848|NC|QO|Daggerfen Poison Vial: 1/1|
C Daggerfen Poison Manual|N|Go up the tower, and loot the manual from the ground.|M|24.40,27.0|QID|9848|NC|QO|Daggerfen Poison Manual: 1/1|
...
C The Sporelings' Plight|N|Loot Mature Spore Sacs off the ground until you finish this quest.|QID|9739|M|14.5,61.6|L|24290 10|S|NC|
C Observing the Sporelings|N|Go here to complete this quest.|M|13.00,60.0|QID|9701|
C The Sporelings' Plight|N|Loot Mature Spore Sacs off the ground until you finish this quest.|QID|9739|M|14.5,61.6|L|24290 10|US|NC|
...
C A Question of Gluttony|N|Go here, killing giants on the way. Loot Discarded Nutriments off the ground until you get enough for this quest.|M|27.00,63.0|QID|9702|NC|
...
C Idols of the Feralfen|N|Kill mobs and loot Idols off the ground until you finish this quest.|M|49.60,59.7|QID|9787|NC|
...
K Mragash|N|Kill Mragash here.|M|42.00, 42.0|QID|9905|T|Mragash|
...
K Terrorclaw|N|Kill Terrorclaw here, Terrorclaw can fear.|M|22.20,45.3|QID|9902|T|Terrorclaw|
...
A Oh, It's On!|QID|9717|N|From T'shu. Optional dungeon quest, skip if you do not want to do it.|O|
...
C Stealing Back the Mushrooms|N|Loot mushrooms from the boxes scattered in the area. Can drop off of Ogres as well.|M|17.00,10.0|QID|9709|S|NC|
C Overlord Gorefist|N|Kill Overlord Gorefist, then kill the rest of the mobs needed for this quest.|M|18.00,8.0|QID|9839|
C Stealing Back the Mushrooms|N|Loot mushrooms from the boxes scattered in the area.|M|17.00,10.0|QID|9709|US|NC|
...
C Messenger to the Feralfen|N|Go here and use Ahuurn's Elixir, then talk to Elder Kurutiin in the building, and go through the dialogue.|M|44.00,66.0|QID|9803|CHAT|

H Boha'mu Runis|QID|9839|N|Hearth to Orebor Harborage.|U|6948|M|41.89,26.29|
