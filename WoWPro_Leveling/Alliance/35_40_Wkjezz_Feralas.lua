...
C Tears of Stone|QID|25396|NC|S|M|41.71,22.54|N|Loot Stonetears (greenish looking crystals) off of the ground.|
C The Land, Corrupted|QID|25397|M|38.77,24.85|N|Kill Corrupted Cliff Giants.|
C Tears of Stone|QID|25396|NC|US|M|40.70,24.16|N|Finish gathering Stonetears.|
...
K General Skessesh|QID|25458|T|General Skessesh|M|30.65,45.46|N|Kill and loot General Skessesh for his head.|
C Hatecrest Forces|QID|25399|US|M|31.26,45.64|N|Finish killing Nagas.|

F Feathermoon Stronghold|QID|25399|M|32.60,45.60|N|Run to Tambre, and ask for a ride back to Feathermoon Stronghold.|
...
C Forces of Nature: Wisps|QID|25407|NC|U|53101|M|56.10,53.37|N|Target the Feralas Wisps and blow the whistle. Should find pleantly floating in the camp.|
...
A Find OOX-22/FE!|QID|25475|S|M|53.30,55.84|N|ll and loot Yetis until you get the OOX-22/FE! Distress Beacon. Accpet this quest from the beacon.|U|8705|
C Improved Quality|QID|25450|M|52.07,58.33|N|Kill and loot Yetis.|
A Find OOX-22/FE!|QID|25475|M|53.30,55.84|N|Kill and loot Yetis until you get the OOX-22/FE! Distress Beacon. Accpet this quest from the beacon.|U|8705|
...
C Forces of Nature: Hippogryphs|QID|25409|NC|U|53104|M|55.28,71.07|N|You can actually stay mounted and do this.|
...
C The Darkmist Legacy|QID|25422|NC|M|63.93,59.85|N|Loot the Glowing Soil from around Darkmist Ruins.|
...
C Forces of Nature: Treants|QID|25410|NC|U|53105|M|58.23,58.86|N|Again you can stay mounted (unless ambushed).|
...
K Bigfist|QID|25433|T|Bigfist|M|74.79,28.41|N|Kill Bigfist.|
...
K Stinglasher|QID|25431|M|78.32,62.74;73.47,63.52|CN|N|Kill Stinglasher. It wanders between, and inside, the two hives. So look for the skull icon on your minimap.|T|Stinglasher|
