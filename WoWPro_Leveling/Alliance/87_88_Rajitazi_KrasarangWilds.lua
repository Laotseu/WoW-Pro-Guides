...
C What's Eating Zhu's Watch?|QID|30079|NC|QO|Speak with Sunni|M|77.5,8.6|N|up the stairs, inside.|
f Zhu's Watch|QID|99999|M|76.7,8.38|N|At Gee Hung.|
...
C Tears of Pandaria|QID|30091|S|M|71.99,11.45|
...
C Tears of Pandaria|QID|30091|US|M|71.99,11.45|
...
C Securing the Province|QID|30083|S|M|77.30,58.91|Z|Valley of the Four Winds|
C Collect Panther Fanks|QID|30088|S|QO|Huge Panther Fang: 18/18|M|72.00,16.91|
C Borderlands|QID|30084|NC|U|78928|QO|Memorial Flame of Po: 1/1|M|75.20,17.20|
C Borderlands|QID|30084|NC|U|78928|QO|Memorial Flame of Zhu: 1/1|M|72.7,18.1|
C Borderlands|QID|30084|NC|U|78928|QO|Memorial Flame of Rin: 1/1|M|71.21,17.55|
C Get the Jar of Pigment|QID|30088|QO|Jar of Pigment: 1/1|M|74.0,56.4|Z|Valley of the Four Winds|
C Collect Panther Fanks|QID|30088|US|QO|Huge Panther Fang: 18/18|M|72.00,16.91|
C Securing the Province|QID|30083|US|M|77.30,58.91|Z|Valley of the Four Winds|
...
K Kill Essence of Despair|QID|30090|QO|Essence of Despair slain: 8/8|M|76.8,9.6|N||
C Zhu's Despair |QID|30090|U|79057|QO|Yi-Mo Cured: 1/1|M|76.43,8.76|N|Use Ken-Ken's Mask on Yi-Mo and fight the big Essence.|
...
f The Incursion|QID|99999|M|67.78,32.52|N|At Tylen Moonfeather.|
...
K Kill Sunwalker Scout|QID|30384|T|Sunwalker Scout|M|66.55,25.08|
...
K Kill Needlebeak|QID|31262|T|Needlebeak|M|63.19,20.39|
K Kill Chasheen|QID|31260|T|Chasheen|M|61.66,31.78|
...
R Ruins of Dojan|QID|30346|M|57.76,36.1|
C Lotus Tea|QID|30351|S|NC|M|55,35|
C Threat from Dojan|QID|30349|S|M|55,35|
K Dojani Dominator|QID|30346|T|Dojani Dominator|M|55.51,35.48|L|78917 1|N|Kill, loot orders.|
...
C The Pools of Youth|QID|30347|M|54.6,32.9;51.63,33.08|N|Chat with Nu Lek, kill the statues that come to life, then click on a water pool to pick it up.|
C Threat from Dojan|QID|30349|US|M|55,35|
C Lotus Tea|QID|30351|US|NC|M|55,35|
T Lotus Tea|QID|30351|M|66.4,32.5|N|To Kang Bramblestaff. (if you dont turn it in right away, you have to wait until you are at sentinal basecamp because Kang goes out of phase, try not to let this happen.)|

R The Incursion|QID|30349|M|67.4,32|
...
R Krasarang River|QID|30178|M|43.83,42.85|
...
T The Murksweats|QID|30268|M|40.5,34.6|N|To Anduin Wrynn.|
...
R Temple of the Red Crane|QID|30272|M|40.5,45.9|
C Sha Can Awe|QID|30271|S|M|37.14,49.70|
C Striking the Rain|QID|30272|S|M|40,45|N|Kill them near the Defenders to get credit for Sha Can Awe also.|
C Clean the West Pagoda|QID|30695|QO|West Pagoda Cleansed: 1/1|M|37.82,54.26|
C Clean the East Pagoda|QID|30695|QO|East Pagoda Cleansed: 1/1|M|42.83,54.35|
...
C Sha Can Awe|QID|30271|US|M|37.14,49.70|
T Ahead on the Way|QID|30695|M|43.00,53.11|N|To Anduin Wrynn.|
...
f Marista|QID|99999|M|52.43,76.53|N|At Nan-Po.|
...
C Wisdom Has A Price|QID|30671|S|M|46.54,77.47|
K Kill Nahassa|QID|30691|T|Nahassa|M|45.84,79.35;46.27,83.42|CS|N|Dive, he is in an underwater cave.|
T Misery|QID|30691|M|46.27,83.42|N|To UI Alert.|
C Wisdom Has A Price|QID|30671|US|M|46.54,77.47|
...
K Unga Fish-Getter|QID|30675|T|Unga Fish-Getter|L|80827|M|45.31,85.17|;I don't think this step is really needed.
A Balance Without Violence|QID|30674|M|45.3,85.6|N|From UI Alert.|
...
C Buried Hozen Treasure|QID|30675|NC|M|51.10,85.27|
T Buried Hozen Treasure|QID|30675|M|51.10,85.27|N|To UI Alert.|
C Balance Without Violence|QID|30674|NC|US|M|42.68,82.74|
...
R Explore|QID|30168|N|If you want, explore the islands while you are out here and have the raft(buff duration 1 hour). You need to check this step off manually.|
f Cradle of Chi-Ji|QID|99999|M|31.19,63.25|N|At Feather Keeper Li.|
R Fallsong Village|QID|30168|M|29.66,39.0|N|You can take your raft up the river (portage around the waterfall).|
...
C Riverblade Flesh-Hunter|QID|30168|L|78958 5|S|M|29.55,45.17|N|If you still have the raft buff, you can go across the water.)
K Kill Slovan|QID|30169|T|Slovan|M|31.87,29.01|QO|Slovan slain: 1/1|
C Riverblade Flesh-Hunter|QID|30168|L|78958 5|US|M|29.55,45.17|
...
f Sentinel Basecamp|QID|99999|M|25.13,33.53|N|At Maylen Moonfeather.|
...
R Shattered Convoy|QID|30357|M|15.94,39.83|
...
K Kill Groundbreaker Brojai|QID|30359|M|23.35,48.80|N|Talk to Lyalia to summon Groundbreaker Brojai.|
...
C The Swarm Begins|QID|30622|S|M|13.3,54.1|Z|Valley of the Four WInds|
...
C Deliver beer to night elf settlers|QID|30624|NC|QO|Deliver beer to night elf settlers: 1/1|M|15.09,50.1|Z|Valley of the Four Winds|
...
C Deliver beer to the Shado-Pan|QID|30624|NC|QO|Deliver beer to Shado-Pan: 1/1|M|10.95,55.9|Z|Valley of the Four Winds|
...
C The Swarm Begins|QID|30622|US|M|13.3,54.1|Z|Valley of the Four WInds|
...
C Students No More|QID|30625|T|Xiao|M|8.9,51.7;9.7,58.3;9.4,54.2;9.6,54.0|CC|Z|Valley of the Four Winds|N|The NPC's will call you over to join them as they roam around this area killing these 4 elites.|
