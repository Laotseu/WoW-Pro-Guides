...
C The Arcanic Oubliette |QID|30274|NC|QO|Southwest Oubliette Shackle destroyed: 1/1|M|66.7,33.7|
C The Arcanic Oubliette |QID|30274|NC|QO|Northwest Oubliette Shackle destroyed: 1/1|M|66.7,31.6|
C The Arcanic Oubliette |QID|30274|NC|QO|Northeast Oubliette Shackle destroyed: 1/1|M|67.9,31.6|
...
C The Lost Dynasty|QID|30344|S|NC|M|68.05,21.47|
...
C Profit Mastery: Chasheen|QID|31260|S|M|61.66,31.78|
C Crane Mastery: Needlebeak|QID|31262|S|M|63.19,20.39|
C The Lost Dynasty|QID|30344|US|NC|M|68.05,21.47|
C Crane Mastery: Needlebeak|QID|31262|US|M|63.19,20.39|
C Profit Mastery: Chasheen|QID|31260|US|M|61.66,31.78|
...
K Kill Dojani Dominator|QID|30346|T|Dojani Dominator|M|55.51,35.48|N|Kill Dojani Dominator. loot orders.|
...
C The Pools of Youth|QID|30347|NC|M|54.6,33.1;51.9,32.4|N|Free Na Lek, kill the guardians and loot the water.|
C Threat from Dojan|QID|30349|US|M|55,35|
C Lotus Tea|QID|30351|US|NS|M|55,35|
...
C Going on the Offensive|QID|30363|NC|M|43.943.4|
...
C The Murksweats|QID|30268|S|M|37.33,41.13|
C Tread Lightly|QID|30694|S|NC|U|80828|M|45.77,28.17|
C Blinding the Riverblades|QID|30270|M|46.14,30.06|
C Tread Lightly|QID|30694|US|NC|U|80828|M|45.77,28.17|
C The Murksweats|QID|30268|US|M|37.33,41.13|
...
K Kill Nahassa|QID|30691|T|Nahassa|M|46.0,79.6;46.3,83.4|CC|N|Nahassa is in a cave, you need to dive at the first way point to find the entrance.|
...
C Buried Hozen Treasure|QID|30675|S|NC|M|51.10,85.27|
C Balance Without Violence|QID|30674|M|42.68,82.74|
T Balance Without Violence|QID|30674|M|42.22,82.87|N|To UI Alert.|
C Buried Hozen Treasure|QID|30675|US|NC|M|51.10,85.27|
T Buried Hozen Treasure|QID|30675|M|51.10,85.27|N|UI Alert.|
...
K Kill Slovan|QID|30169|T|Slovan|M|31.87,29.01|
...
C Sever Their Supply Line|QID|30356|S|M|23.70,42.04|
C Re-Reclaim|QID|30355|S|NC|M|23.43,45.24|
C No Sister Left Behind|QID|30354|NC|M|23.49,45.07|
C Re-Reclaim|QID|30355|US|NC|M|23.43,45.24|
C Sever Their Supply Line|QID|30356|S|M|23.70,42.04|
...
C The Stoneplow Convoy|QID|30357|NC|U|79163|M|15.62,34.96|
C The Mantid|QID|30361|S|M|14.44,35.46|
...
K Kill Groundbreaker Brojai|QID|30359|T|Groundbreaker Brojai|M|23.35,48.80|
...
C Students No More|QID|30625|T|Xiao|M|8.9,51.7;9.7,58.3;9.4,54.2;9.6,54.0|CC|Z|Valley of the Four Winds|N|The studends will call you over to join them as they roam around this area killing these 4 elites.|
