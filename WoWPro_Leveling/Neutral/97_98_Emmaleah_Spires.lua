...
C Echo Hunters|QID|34805|M|50.23,39.80|US|N|These are bats, (up in the air), you need ranged to get thier attention.|T|Echo Hunter|
...
h Southport|QID|35293|M|40.12,61.49|N|At Elria Willowfall.\nIf you built the brewery, there is really no reason to bind here as it's ability is a port back here from anywhere in the zone.|FACTION|Alliance|
...
D Your Garrison|U|110560|M|40.18,43.5|N|This ends Spires of Arak.  The final leveling zone quide, Nagrand, should load after you check off this step.|
