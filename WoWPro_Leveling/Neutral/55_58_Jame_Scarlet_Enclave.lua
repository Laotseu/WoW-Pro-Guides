...
C Get the Empty Cauldron |QID|12716|NC|QO|Empty Cauldron: 1/1|N|Get out of the crypt and go southeast to New Avalon. On your left-hand side you will see the New Avalon Inn. The Empty Cauldron is in the basement.|M|57.80,61.86|C|DeathKnight|
C Get the Iron Chain |QID|12716|NC|QO|Iron Chain: 1/1|N|Northeast of the inn you'll find the New Avalon Forge.|M|61.99,60.24|C|DeathKnight|
...
C The Path Of The Righteous Crusader |QID|12724|NC|N|Ride northeast to the Scarlet Hold and loot the [New Avalon Patrol Schedule] on the upper floor.|M|63.0,68.3|C|DeathKnight|
