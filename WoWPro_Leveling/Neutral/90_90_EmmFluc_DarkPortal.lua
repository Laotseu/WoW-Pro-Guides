...
K Slay Ungra |QID|34431;34737|T|Ungra|N|Kill Ungra. Head up the first stairs, then take the next set of stairs to the left, then to the left.|QO|1|M|44.0,74.5|Z|Tanaan Jungle|FACTION|Alliance|
K Slay Taskmaster Gurran |QID|34431;34737|T|Taskmaster Gurran|N|Straight along the corridor behind you. Watch for the hole in the floor.|QO|2|M|56.2,19.8|Z|Tanaan Jungle|FACTION|Alliance|
...
K Keli'dan the Breaker|QID|34436;34741|T|Keli'dan the Breaker|N|Kill Keli'dan the Breaker.|M|35.2,50.4|Z|TanaanJungleIntro|FACTION|Alliance|
