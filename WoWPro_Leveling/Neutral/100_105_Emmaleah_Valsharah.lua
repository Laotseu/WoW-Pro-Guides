...
C Tying Up Loose Ends|QID|39861|CHAT|M|69.83,51.21|Z|Dalaran@Dalaran70|QO|1|NC|N|Free (Chat Option)flight to Val'sharah taken from Aludane Whitecloud.|CHAT|
...
$ Glimmering Treasure Chest|QID|39089|M|61.0,79.2|N|In a little cave, loot for a bit of treasure and resources.|
...
C Totemic Call|QID|38246|NC|M|48.87,88.52|N|Nightmare Totem destroyed|
...
A Lieutenant of the Tower|QID|38721|M|39.48,42.10|N|From Malev Shadowsong.|RANK|2|
