...
f Tavern in the Mists|M|56.75,75.82|Z|The Veiled Stair|N|At Shin the Weightless.|
...
R Temple of the White Tiger|QID|30617|M|66.8,59.29;68.4,56.08;69.05,52.48;66.33,50.71|CS|; no good QID to use for this...since it comes just before faction based steps.
f Temple of the White Tiger|QID|30617|M|66.33,50.71|N|At Big Greenfeather.|
...
R Grummle Bazaar|CC|M|64.24,59.45|
...
F One Keg||M|62.44,30.16|CC|N|At Bo the Wind Claimer.|
...
F Eastwind Rest|QID|31511|FACTION|Horde|M|42.78,69.58|CC|N|At Uncle Eastwind.|
A Beyond the Wall|QID|31695|FACTION|Horde|M|62.36,79.65|N|From Elder Shiao.|
...
F Westwind Rest|QID|30512|FACTION|Alliance|M|42.78,69.58|CC|N|At Uncle Eastwind.|
A Beyond the Wall|QID|31695|FACTION|Alliance|M|54.13,83.37|N|From Elder Tsulan.|
...
f Serpent's Spine|QID|30690|M|43.92,89.56|N|Up the stairs, at Kite Master Ni.|
F Kota Basecamp||QID|30747|M|62.44,30.16|CC|N|At Bo the Wind Claimer.|
...
T Where are My Reinforcements?|QID|30993|M|35.29,49.45|Z|Kun-Lai Summit|N|To Ban Bearheart.|
...
N Congratulations, you have now finished Kun-Lai Summit|N|You have probably also achieved level 90 and may want to explore Vale of Eternal Blossoms. If you want to continue with the guide Townlong Steppes will load when you check off this step.|
